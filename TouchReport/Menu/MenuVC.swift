...
//
//  Created by Anuwesh Khadka on 11/25/22.
//
...
class MenuVC: UIViewController, UIGestureRecognizerDelegate {
    ...
    lazy var contentView: UIView = {
        ...
        mainView.backgroundColor = UIColor(named: "#1E255E")
    ...
    lazy var lblCopyright: UILabel = {
        ...
        lblCopyright.text = "TouchReport © made by ANUWESH"
...
extension MenuVC {
    ...
    private func autoLayoutMainView() {
        ...
        NSLayoutConstraint.activate([
            ...
            contentView.leadingAnchor.constraint(equalTo: blurView.contentView.trailingAnchor),
            
            contentView.trailingAnchor.constraint(equalTo: blurView.contentView.trailingAnchor),
            
            contentView.widthAnchor.constraint(equalTo: blurView.contentView.widthAnchor)
    ...
    private func autoLayoutViewSeparator() {
        ...
        NSLayoutConstraint.activate([
            ...
            viewSeparator.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 15),
...
//    }
    ...
    private func autoLayoutForTitleStack() {
        ...
        NSLayoutConstraint.activate([
            ...
            stkTitle.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 27),
            
            stkTitle.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -27)
    ...
    private func autoLayoutForBottomStack() {
        ...
        NSLayoutConstraint.activate([
            ...
            stkBtm.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 27),
            
            stkBtm.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -27)
