...
//
//  Created by Anuwesh Khadka on 11/23/22.
//
...
class UserDashBoardVC: UIViewController {
    ...
    lazy var btnNeedHelp: UIButton = {
        
        let btnNeedHelp = UIButton()
        ...
        btnNeedHelp.addTarget(self, action: #selector(didTapNeedHelp), for: .touchUpInside)
    ...
    @objc func didTapNeedHelp () {
        
        let vc = PersonalHelpVC()
